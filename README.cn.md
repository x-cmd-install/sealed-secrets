...
[![x-cmd/install — sealed-secrets Code Quality Monitoring Repo Card](https://repo.x-cmd.io/sealed-secrets.svg?lang=zh)](https://x-cmd.com/install/sealed-secrets)
...
- **Star**: 9,285 · **Fork**: 777 · **开放 issue**: 608 · **贡献者**: 184

## 累计统计

- **发布数**: 204 · **已合并 PR**: 1158 · **开放 PR**: 0 · **已关闭 issue**: 543 · **开放 issue**: 65 · **提交数**: 1689
...
_数据快照: `data/card/260920.yml` · 2026-09-20T06:14:23Z._
