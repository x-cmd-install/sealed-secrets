...
[![x-cmd/install — sealed-secrets Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/sealed-secrets.svg?lang=zh)](https://x-cmd.com/install/sealed-secrets)
...
合计: **16,898** 行代码（覆盖前 5 种语言、共 **134** 个文件）。
...
- **Star**: 9,286 · **Fork**: 779 · **开放 issue**: 608 · **贡献者**: 184

## 累计统计

- **发布数**: 204 · **已合并 PR**: 1158 · **开放 PR**: 3 · **已关闭 issue**: 543 · **开放 issue**: 65 · **提交数**: 1689
...
_数据快照: `data/card/260923.yml` · 2026-09-23T06:30:53Z._
